                        ...
                        <div className="px-5 py-7">
                            <div className="flex">
                                <input
                                    ...
                                    className="border rounded-lg px-3 py-2 mt-1 mr-2 mb-5 text-sm w-full"
                                />
                                <input
                                    type="text"
                            ...
                            <button type="submit"
                                ...
                                <span
                                    className="inline-block mr-2">{formik.isSubmitting ? "Signing Up..." : "Sign Up"}</span>
                                {formik.isSubmitting ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 inline-block">
