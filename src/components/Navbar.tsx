                    ...
                    <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
                        <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                            ...
                            {user && (<li>
                                <Link
                                    to="/chats"
                                    className={window.location.pathname === "/chats" ? "block py-2 pr-4 pl-3 text-white md:p-0 dark:text-blue-300" : "block py-2 pr-4 pl-3 text-white md:p-0 dark:text-white"}
                                    aria-current="page"
                                >
                                    {
                                        unreadMessageCount > 0 && (
                                            <span
                                                ...
                                                <span
                                                    className="text-xs font-medium leading-none text-gray-800">{unreadMessageCount}</span>
                                            </span>
                                        )
                                    }
